...
<html lang="en">
  ...
  <body  style="background:url(img/bankimg1.jpg) ;background-repeat:no-repeat; bcakground-size: 100% 100%"> 
  <?php
  include 'navbar.php';
  ?>
      ...
      <!-- Introduction section -->
            ...
            <div class="row intro py-1" style="background-color : #4bc0d08c;">
      ...
      <footer class="text-center mt-5 py-2">
        <p>&copy 2021. <b>INDIAN BANK</b> <br> Banking Foundation</p>
      </footer>
